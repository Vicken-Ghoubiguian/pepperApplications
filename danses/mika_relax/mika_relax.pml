...
<Package name="mika_relax" format_version="4">
    <Manifest src="manifest.xml" />
    <BehaviorDescriptions>
        <BehaviorDescription name="behavior" src="." xar="behavior.xar" />
    </BehaviorDescriptions>
    <Dialogs>
        <Dialog name="dance_mika_relax" src="dance_mika_relax/dance_mika_relax.dlg" />
    </Dialogs>
    <Resources>
        <File name="icon" src="icon.png" />
        <File name="09_Relax" src="09_Relax.ogg" />
    ...
    <Topics>
        <Topic name="dance_mika_relax_enu" src="dance_mika_relax/dance_mika_relax_enu.top" topicName="mika_relax" language="en_US" />
        <Topic name="dance_mika_relax_frf" src="dance_mika_relax/dance_mika_relax_frf.top" topicName="mika_relax" language="fr_FR" />
        <Topic name="dance_mika_relax_jpj" src="dance_mika_relax/dance_mika_relax_jpj.top" topicName="mika_relax" language="ja_JP" />
    </Topics>
    <IgnoredPaths />
